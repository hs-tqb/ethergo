<style lang="less">
  ...
  */
  ...
  @media print{ .hljs{overflow: visible; word-wrap: break-word !important;} }
</style>

<template>
  <div id="page-help-dapp">
    <div class="markdown-body">
    <h1 id="toc_0">DAPP浏览器安装使用说明</h1>

    <h2 id="toc_1">安装</h2>

    <p>DAPP浏览器是猎豹旗下的应用，官网地址：<a href="https://www.cmcmbc.com/en-us/dapp-browser/">https://www.cmcmbc.com/en-us/dapp-browser/</a></p>

    <p><strong>安装方法一</strong>：<br/>
    通过官网去android、ios官方商店下载（该应用未在大陆推广，需翻墙）</p>
    ...
    <img src="http://od3p9hvyr.bkt.clouddn.com/2018-05-10_15-20-11.png" alt=""/><br/>
    然后登陆美区App Store账号：<a href="mailto:c8501b3@icloud.com">c8501b3@icloud.com</a>  密码：Xx223322，搜索DAPP Browser,点击安装</p>

    <h2 id="toc_2">使用方法</h2>

    <p>1.打开DAPP浏览器，在Dapps栏上方，输入etherwow.io,确认访问<br/>
    <img src="http://od3p9hvyr.bkt.clouddn.com/2018-05-10_15-36-44.png" alt=""/></p>

    <p>2.即可访问到etherwow dapp，etherwow将自动识别钱包地址和余额<br/>
    <img src="http://od3p9hvyr.bkt.clouddn.com/2018-05-10_15-39-48.png" alt=""/></p>

    <p>3.玩家可在钱包栏，点击接收按钮<br/>
    <img src="http://od3p9hvyr.bkt.clouddn.com/2018-05-10_15-40-45.png" alt=""/></p>

    <p>然后复制钱包地址<br/>
    <img src="http://od3p9hvyr.bkt.clouddn.com/2018-05-10_15-41-13.png" alt=""/></p>

    <p>4.将其他钱包的余额转到DAPP钱包地址。这样，就可以使用DAPP浏览器访问etherwow.io进行投注了！</p>
    </div>
  </div>
</template>
